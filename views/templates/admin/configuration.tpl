...
<div class="bootstrap panel">
	...
	<div class="row">
		...
		<div class="em-center-block" style="max-width: 60em;">
			...
			<img src="../modules/expressmailing/views/img/graph.png" style="width: 500px; max-width: 100%" class="em-center-block"/>
		</div>
	</div>
	<div class="row">
		<div class="em-center-block text-center row-margin-bottom" style="max-width: 60em;">
			<hr/>
			<h2 class="text-uppercase" style="margin-top: 0px;">{l s='Quick training' mod='expressmailing'}</h2>
			...
			<div class="col-lg-4"><img src="../modules/expressmailing/views/img/{l s='tel_en.gif' mod='expressmailing'}" style="max-width: 100%"/></div>
		</div>
	</div>
	<div class="row">
		<div class="em-center-block text-center row-margin-bottom" style="max-width: 60em;">
			<hr/>
			<h2 class="text-uppercase" style="margin-top: 0px;">{l s='Loss leader pricing' mod='expressmailing'}</h2>
