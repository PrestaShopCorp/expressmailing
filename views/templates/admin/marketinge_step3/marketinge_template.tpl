	...
	<td align="center" style="padding: 10px 50px">
		...
		<tr>
			<td>
				...
				<tr>
					<td align="left"><span style="font-family: Verdana, Helvetica, sans-serif; font-size: 14pt;">{l s='%s Newsletter' mod='expressmailing' sprintf=$shop_name}</span></td>
				</tr>
				<tr>
					<td align="left">&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<td align="center">
						<font size="1">
							{$footer|replace:['[br]','[www]']:['<br/>',$site]}&nbsp;&nbsp;|&nbsp;&nbsp;<a href="##DESABONNEMENT##">{l s='Unsubscribe' mod='expressmailing'}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="##AMI##">{l s='Forward to a friend' mod='expressmailing'}</a>
						</font>
					</td>
				</tr>
				</table>
