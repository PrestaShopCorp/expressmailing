	...
	<div class="form-wrapper" style="overflow-x: hidden; overflow-y: auto; padding-left: 5px; margin-right: 0px">
		...
		<div class="form-group">
			...
			<div class="col-lg-12" style="padding-left: 20px">
				...
				<div class="checkbox gamification_notif">
					<label for="groups[{$group.id_group|escape:'intval'}]"><input type="checkbox" value="1" class="checkbox-inline" id="groups[{$group.id_group|escape:'intval'}]" name="groups[{$group.id_group|escape:'intval'}]" {if $group.checked}checked="checked"{/if}>{$group.name|escape} &nbsp; <span class="badge" style="font-size: smaller">{$group.total|escape:'intval'}</span></label>
				</div>
				{/foreach}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-12" style="padding-left: 20px">
				...
				<div class="checkbox">
					<label for="langs[{$lang.id_lang|escape:'intval'}]"><input type="checkbox" value="1" class="checkbox-inline" id="langs[{$lang.id_lang|escape:'intval'}]" name="langs[{$lang.id_lang|escape:'intval'}]" {if $lang.checked}checked="checked"{/if}>{$lang.name|escape} &nbsp; <span class="badge" style="font-size: smaller">{$lang.total|escape:'intval'}</span></label>
				</div>
				{/foreach}
			</div>
		</div>
