...
<div class="panel" style="height: 430px; margin-bottom: 0px; padding-bottom: 0px; background-color: #F2DEDE; box-shadow: 0 2px 0 rgba(0, 0, 0, 0.1);">
	...
	<div style="width: 100%; text-align: center">
		...
		<div>&nbsp;</div>
		<a class="btn btn-default" href="index.php?controller=AdminMarketingBuy&product=email-filter-12-months&media=AdminMarketingEStep4&token={Tools::getAdminTokenLite('AdminMarketingBuy')|escape}"><i class="icon-shopping-cart"></i> &nbsp;{l s='49,00 € per year' mod='expressmailing'}</a>
	</div>
</div>
