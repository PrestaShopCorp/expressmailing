...
<div id="footer" class="bootstrap hide" style="background-color: white; padding: 8px 0 0 0px; margin: 0px; line-height: 15px">
	...
	<tr>
		...
		<td align="center"><img border="0" hspace="10" title="{l s='+33 169.313.961' mod='expressmailing'} : {l s='International call price' mod='expressmailing'}" src="../modules/expressmailing/img/{l s='tel_en.gif' mod='expressmailing'}">{if $price != 'International call price'}<br><font style="font-size: .75em; color: #7E7E7E">{$price|escape}</font>{/if}</td>
	</tr>
	</table>
